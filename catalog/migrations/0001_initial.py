# Generated by Django 3.2.5 on 2022-09-16 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter the description of the book', max_length=1500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_name', models.CharField(help_text="Enter the book's language", max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
